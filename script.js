    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עמית - ענה מיד לתשובות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '0a5d0575-a513-4ac2-b896-1b2f861f39e9',
                    name: data.name || '',
                    email: data.email || '',
